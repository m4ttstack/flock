...
final class PaneMenuModelTests: XCTestCase {
    ...
    func testEntriesOrderWithNoFocusedPane() {
        ...
        XCTAssertEqual(entries.map(\.accessibilityIdentifier), [
            "flock.pane.menu.rename",
            "flock.pane.menu.splitRight",
            "flock.pane.menu.splitDown",
            "flock.pane.menu.zoom",
            "flock.pane.menu.moveTo",
            "flock.pane.menu.closePane",
        ])
    }
    ...
    func testEntriesOrderWithSwapBetweenRenameAndTheSplitsWhenAnotherPaneInTheSameTabIsFocused() {
        ...
        XCTAssertEqual(entries[1].accessibilityIdentifier, "flock.pane.menu.swap")
    ...
    func testClearPaneNameAppearsOnlyForAPaneWithAManualLabel() {
        ...
        XCTAssertEqual(labelled[1].accessibilityIdentifier, "flock.pane.menu.clearName")
    ...
    func testSplitAndCloseAreAlwaysPresentAndEnabled() {
        ...
        let splitRight = entries.first { $0.accessibilityIdentifier == "flock.pane.menu.splitRight" }
        let splitDown = entries.first { $0.accessibilityIdentifier == "flock.pane.menu.splitDown" }
        let close = entries.first { $0.accessibilityIdentifier == "flock.pane.menu.closePane" }
