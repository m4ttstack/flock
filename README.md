...
| <kbd>⌥</kbd><kbd>⌘</kbd><kbd>M</kbd>, or click a pane's mouse icon | Send the focused pane's plain right-clicks to its program, or back to the pane menu (the icon shows while the program has the mouse) |
