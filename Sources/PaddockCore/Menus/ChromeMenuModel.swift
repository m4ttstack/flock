...
/// Close even on a workspace's last tab, and paddock does not second-guess it.
...
public enum TabMenuModel {
    public static func entries(for tab: TabID, model: SessionModel) -> [ChromeMenuEntry<TabMenuAction>] {
        ...
        return [
            ChromeMenuEntry(label: "New Tab", action: .newTab(workspace), accessibilityIdentifier: "paddock.tab.menu.newTab"),
            ChromeMenuEntry(label: "Rename", action: .rename, accessibilityIdentifier: "paddock.tab.menu.rename"),
            ChromeMenuEntry(label: "Close", action: .close, accessibilityIdentifier: "paddock.tab.menu.close"),
        ]
    }
}
...
/// Expand/Collapse); paddock mirrors the two it has a capability for and
/// offers none of the worktree rows, since nothing in paddock manages a
...
public enum WorkspaceMenuModel {
    public static func entries(for workspace: WorkspaceID, model: SessionModel) -> [ChromeMenuEntry<WorkspaceMenuAction>] {
        ...
        return [
            ChromeMenuEntry(label: "Rename", action: .rename, accessibilityIdentifier: "paddock.workspace.menu.rename"),
            ChromeMenuEntry(label: "Close", action: .close, accessibilityIdentifier: "paddock.workspace.menu.close"),
        ]
    }
}
